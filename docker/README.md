...
- [ ] use ollama inside docker
- [ ] automatic health check for all endpoints
- [ ] have buttons for RAG evaluation metrics (UI)
- [ ] have buttons in UI for Graphana , flower , celery
